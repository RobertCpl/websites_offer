  ...
  <section class="grid grid-cols-1 min-h-[600px] lg:grid-cols-12 mb-16 gap-x-6 gap-y-6">
    ...
    <div class="col-span-1 lg:col-span-5 bg-linear-to-br from-[#A5B4FC] to-[#C7D2FE] rounded-[3rem] relative overflow-hidden clay-card group animate-enter delay-200 h-[400px] lg:h-auto">
      ...
      <div class="absolute inset-0 flex items-center justify-center transform group-hover:scale-105 transition-transform duration-700 ease-out">
        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/hero-megaphone.jpg'); ?>" alt="3D Megaphone Abstract" class="filter contrast-125 opacity-90 mix-blend-multiply w-[120%] h-[120%] object-cover brightness-110">
      </div>
    ...
    <div class="col-span-1 lg:col-span-7 flex flex-col gap-6">
      ...
      <div class="flex-1 overflow-hidden clay-card animate-enter delay-300 min-h-[300px] bg-[#BFDBFE] rounded-[3rem] relative">
        ...
        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/hero-icon.webp'); ?>" class="filter contrast-125 transform hover:scale-105 transition-transform duration-700 ease-out opacity-90 mix-blend-multiply w-full h-full object-cover absolute top-0 right-0 bottom-0 left-0 brightness-110" alt="3D Icon">
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6 animate-enter delay-500 min-h-[280px] gap-x-6 gap-y-6">
        ...
        <div class="overflow-hidden clay-card min-h-[280px] bg-[#6366f1] rounded-[3rem] relative">
          <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/bento-purple.jpg'); ?>" class="absolute inset-0 w-full h-full object-cover mix-blend-hard-light filter brightness-75 contrast-125" alt="Purple texture">
          ...
          <div class="flex absolute bottom-12 right-12 items-center justify-center">
            <div class="relative group cursor-pointer">
              ...
              <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/profile-320.jpg'); ?>" class="transform group-hover:scale-105 transition-transform duration-300 z-10 w-40 h-32 object-cover border-white/30 border-4 rounded-3xl relative shadow-2xl" alt="Profile photo">
            </div>
          </div>
        </div>
      </div>
